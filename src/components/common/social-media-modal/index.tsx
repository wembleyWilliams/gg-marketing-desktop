...
const SocialMediaModal = (props: Props) => {
  ...
  const [localIsOpen, setLocalIsOpen] = useState(undefined)
                ...
                {({
                  ...
                  <form onSubmit={handleSubmit}>
                    <FormControl>
                      ...
                      <FormHelperText
                        className={touched.handle && errors.handle ? classes.helperErrorText: classes.helperText}>
                        {touched.handle && errors.handle ? errors.handle :
